...
})({"isbYk":[function(require,module,exports,__globalThis) {
...
var _accountTransaction = require("./accountTransaction");
var _accountTransactionDefault = parcelHelpers.interopDefault(_accountTransaction);
var _table = require("./table");
var _utils = require("./utils");
window.onload = ()=>{
    (0, _utils.focusForm)('#income');
    const transactions = new (0, _accountTransactionDefault.default)();
    (0, _table.fillTable)(transactions.allAccountTransactions(), '#records_body');
    (0, _utils.totalIncomes)(transactions.incomes.totalIncome());
    (0, _utils.totalExpenses)(transactions.expenses.totalExpenses());
    (0, _utils.accountBalance)(transactions.accountBalance);
    ...
    tableBody.addEventListener('click', function(event) {
        ...
        if (row.tagName === 'TR') row.classList.add('selected'); // Add selected class to clicked row
    });
    ...
    removeBtn.addEventListener('click', ()=>{
        const selectedRecords = (0, _table.removeTableRecords)();
        ...
        const accountTransactions = new (0, _accountTransactionDefault.default)();
...
function handleIncome(e) {
    ...
    if (!(0, _utils.hasEmptyValues)(incomeObj)) {
        const accountTransactions = new (0, _accountTransactionDefault.default)();
        accountTransactions.incomes.addIncome(incomeObj);
        const transactions = accountTransactions.allAccountTransactions();
        (0, _table.fillTable)(transactions, '#records_body');
        (0, _utils.totalIncomes)(accountTransactions.incomes.totalIncome());
        (0, _utils.accountBalance)(accountTransactions.accountBalance);
    }
    (0, _utils.clearForm)('#income');
}
function handleExpense(e) {
    ...
    if (!(0, _utils.hasEmptyValues)(expenseObj)) {
        const accountTransactions = new (0, _accountTransactionDefault.default)();
        accountTransactions.expenses.addExpense(expenseObj);
        const transactions = accountTransactions.allAccountTransactions();
        (0, _table.fillTable)(transactions, '#records_body');
        (0, _utils.totalExpenses)(accountTransactions.expenses.totalExpenses());
        (0, _utils.accountBalance)(accountTransactions.accountBalance);
    }
    (0, _utils.clearForm)('#expense');
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"bh0vM","./accountTransaction":"cpboE","./table":"cTaMp","./utils":"azjDB"}],"bh0vM":[function(require,module,exports,__globalThis) {
...
},{}],"cpboE":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _expenseTransactionJs = require("./expenseTransaction.js");
var _expenseTransactionJsDefault = parcelHelpers.interopDefault(_expenseTransactionJs);
var _incomeTransactionJs = require("./incomeTransaction.js");
var _incomeTransactionJsDefault = parcelHelpers.interopDefault(_incomeTransactionJs);
var _personJs = require("./person.js");
var _personJsDefault = parcelHelpers.interopDefault(_personJs);
class AccountTransaction extends (0, _personJsDefault.default) {
    constructor(firstName, lastName, incomes = [], expenses = []){
        super(firstName, lastName);
        this.incomes = new (0, _incomeTransactionJsDefault.default)(incomes);
        this.expenses = new (0, _expenseTransactionJsDefault.default)(expenses);
    }
    accountInfo() {
        return {
...
},{"./expenseTransaction.js":"6R2r4","./incomeTransaction.js":"1DNxi","./person.js":"5H2Kh","@parcel/transformer-js/src/esmodule-helpers.js":"bh0vM"}],"6R2r4":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
exports.default = ExpenseTransaction;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"bh0vM"}],"1DNxi":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class IncomeTransaction {
    ...
    loadIncomesFromLocalStorage() {
        ...
        if (storedIncomes) this.incomes = JSON.parse(storedIncomes);
    }
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"bh0vM"}],"5H2Kh":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class Person {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"bh0vM"}],"cTaMp":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "addTableRecord", ()=>addTableRecord);
parcelHelpers.export(exports, "removeTableRecords", ()=>removeTableRecords);
parcelHelpers.export(exports, "clearTableBody", ()=>clearTableBody);
parcelHelpers.export(exports, "fillTable", ()=>fillTable);
function addTableRecord(record, type) {
...
function removeTableRecords() {
    ...
    for (const record of recordsInTable){
        for (const cell of record.children){
            ...
            Object.assign(recordsToRemove, {
                [key]: key === 'amount' ? parseInt(cell.textContent) : cell.textContent
            });
        }
        record.remove();
    }
...
function fillTable(records, table) {
    clearTableBody(table);
    for (const transaction of records)addTableRecord(transaction);
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"bh0vM"}],"azjDB":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "hasEmptyValues", ()=>hasEmptyValues);
parcelHelpers.export(exports, "clearForm", ()=>clearForm);
parcelHelpers.export(exports, "focusForm", ()=>focusForm);
parcelHelpers.export(exports, "totalIncomes", ()=>totalIncomes);
parcelHelpers.export(exports, "totalExpenses", ()=>totalExpenses);
parcelHelpers.export(exports, "accountBalance", ()=>accountBalance);
...
function hasEmptyValues(data) {
    ...
    for(const value in data){
        ...
        if (data[value] === "" || data[value] === null || data[value] === undefined || typeof data[value] === 'string' && value.trim() === "") return true; // Found an empty value
    }
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"bh0vM"}]},["isbYk","NhzJs"], "NhzJs", "parcelRequire46fc", {})

//# sourceMappingURL=Practice.0be11312.js.map
